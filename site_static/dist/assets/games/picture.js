...
(function () {
  ...
  function renderPictureMatch(app) {
    ...
    function onPick(word, btn) {
      var correct = words[idx].word;
      answered++;
      var allBtns = body.querySelectorAll('.pm-opt');
      allBtns.forEach(function (b) { b.disabled = true; });
      var isCorrect = GS.equalsIgnoreCase(word, correct);
      if (isCorrect) {
        ...
        allBtns.forEach(function (b) {
          if (b.dataset.w.toLowerCase() === correct.toLowerCase()) b.classList.add('pm-correct');
        });
      }
      refreshHeader();
      idx++;
