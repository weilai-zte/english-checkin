...
(function () {
  ...
  var WORD_EMOJI = {
    ...
    'umbrella':'☂️','mirror':'🪞','camera':'📷','gift':'🎁','balloon':'🎈',
    'candle':'🕯️','flag':'🚩','crown':'👑','envelope':'✉️','letter':'✉️',
    'package':'📦','trophy':'🏆','medal':'🏅','ticket':'🎫',
    'pizza':'🍕','hamburger':'🍔','sandwich':'🥪','cookie':'🍪','candy':'🍬',
    'ice cream':'🍦','juice':'🧃','soup':'🍲','salad':'🥗','noodles':'🍜',
    'spaghetti':'🍝','sushi':'🍣','dumpling':'🥟','popcorn':'🍿','donut':'🍩',
    'butter':'🧈','cheese':'🧀','honey':'🍯','salt':'🧂','fork':'🍴',
    'spoon':'🥄','plate':'🍽️','bowl':'🥣','cup':'🥤','bottle':'🍼',
    'rainbow':'🌈','ocean':'🌊','island':'🏝️','volcano':'🌋','desert':'🏜️',
    'park':'🏞️','forest':'🌲','beach':'🏖️','bridge':'🌉','cave':'🕳️',
    'tent':'⛺','castle':'🏰','tower':'🗼',
    'snake':'🐍','frog':'🐸','butterfly':'🦋','bee':'🐝','ant':'🐜',
    'spider':'🕷️','whale':'🐋','shark':'🦈','dolphin':'🐬','eagle':'🦅',
    'owl':'🦉','fox':'🦊','wolf':'🐺','giraffe':'🦒','zebra':'🦓',
    'kangaroo':'🦘','panda':'🐼','koala':'🐨','camel':'🐪','penguin':'🐧',
    'parrot':'🦜','swan':'🦢','crab':'🦀','octopus':'🐙','shrimp':'🦐',
    'shirt':'👕','pants':'👖','shoes':'👟','hat':'🎩','coat':'🧥',
    'dress':'👗','socks':'🧦','gloves':'🧤','scarf':'🧣','boots':'👢',
    'glasses':'👓','ring':'💍','necklace':'📿',
    'toothbrush':'🪥','soap':'🧼','towel':'🧻','comb':'🪮','scissors':'✂️',
    'paint':'🎨','eraser':'🧽','glue':'🧴',
    'telescope':'🔭','microscope':'🔬','compass':'🧭','hammer':'🔨',
    'screwdriver':'🪛','wrench':'🔧','ladder':'🪜','lock':'🔒',
    'bell':'🔔','drum':'🥁','guitar':'🎸','piano':'🎹','violin':'🎻',
    'trumpet':'🎺',
