...
### statement
english-checkin 是初一英语每日打卡系统：每天通过飞书推送练习题，孩子在公网完成词汇/语法/翻译练习，进度存浏览器 localStorage，离线可用。
...
|------|-------------|------|
| `functional_requirements` | 本文 §3 (F-001~F-016, 16 条) | json |
| `non_functional_requirements` | 本文 §4 (N-001~N-006, 6 条) | json |
...
| **F-004** | P0 | 公网地址永久固定 (cheerful-puffpuff-a1b9eb.netlify.app) | send_daily.py PUBLIC_URL 已硬编码 |
...
| **F-016** | P2 | 知识课程页面文字对比度提升：正文 #1a1a2e + 标题 #2d3748 + 暗色模式覆盖 | /knowledge 文字清晰可读 |
...
- **Actor**: 孩子
- **前置**: 公网 URL 可访问
- **主流程**: 浏览器打开 cheerful-puffpuff-a1b9eb.netlify.app → 首页难度选择 → 点 /learn
- **后置**: 进入每日学习任务
