...
| **F-011** | P1 | 知识课程 9 个 tab（时态/介词/冠词/名词/写作/句子结构/数量词/核心句型/高级语法），每个模块包含文字大纲与学习海报 | knowledge_outline.md 含模块1至模块9标题 + site_static/assets/knowledge/m1.png 至 m9.png |
...
- **Actor**: 孩子
- **前置**: 公网 URL 可访问
- **主流程**: /knowledge → 9 个 tab（时态/介词/冠词/名词/写作/句子结构/数量词/核心句型/高级语法）
- **后置**: 浏览知识课程
- **异常**: 手机端折叠 accordion
